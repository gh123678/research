...
8. H7: no sealed SCIENCE file changed
  ...
  INFO  shared evaluator evaluate_fp_iter2_001.py changed after this task was sealed. It is not part of the scientific corpus; the horizon knob inside it was later extended (FP-ITER4-001 added the value 4, FP-ITER5-001 added 5). The evolution is proven inert: a re-run at the frozen horizon reproduces all 90 sealed step entries exactly.
